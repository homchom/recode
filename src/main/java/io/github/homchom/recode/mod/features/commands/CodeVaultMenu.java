...
public class CodeVaultMenu extends LightweightGuiDescription implements IMenu {
    ...
    private void fetch() {
        // TODO: Don't use ws server, tk has access to the original server and data so they can expose this via http.
//        RecodeServer.requestMessage(new WebMessage("code-vault"), message -> {
